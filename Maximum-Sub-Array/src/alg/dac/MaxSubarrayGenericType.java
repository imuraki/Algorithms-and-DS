...
public abstract class MaxSubarrayGenericType <E extends Comparable<E>> {
    ...
    public SubArrayInfoGenericType<E> findMSS(ArrayList<E> A, int low, int high){
        ...
        if (low < high){
            ...
            return leftMax.compareTo(rightMax) == 1 ? leftMax.compareTo(crossMax) == 1 ? leftMax : crossMax : rightMax.compareTo(crossMax) == 1 ? rightMax : crossMax;
